...
import { type AgencyBase } from '../../types/agency.types';
...
interface AgencyFormProps {
  initialValues?: Partial<AgencyBase>;
  onSubmit: (data: AgencyFormValues) => void;
  isSubmitting: boolean;
}

export const AgencyForm: React.FC<AgencyFormProps> = ({ initialValues, onSubmit, isSubmitting }) => {
  ...
  // Helper to convert empty strings to undefined before submitting if optional in backend
  const handleFormSubmit = (data: AgencyFormValues) => {
    ...
    onSubmit(cleanedData as AgencyFormValues);
  };
