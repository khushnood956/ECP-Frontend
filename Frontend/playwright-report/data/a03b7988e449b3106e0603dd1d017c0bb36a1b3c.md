...
- Name: auth.spec.js >> Authentication & Profile UI - Tier 1 & 2 >> T2.3: Register with password mismatch
- Location: tests\auth.spec.js:109:3
...
- paragraph: Join the student portal dashboard
- text: Full Name
- textbox "Full Name":
...
- textbox "Email Address":
  ...
  - text: new@test.com
- text: Degree Preference
- combobox "Degree Preference":
  - option "Bachelor of CS"
  - option "Master of CS" [selected]
  - option "Master of Data Science"
  - option "MBA"
  - option "PhD in Engineering"
- text: IELTS Score
- combobox "IELTS Score":
  - option "6.0"
  - option "6.5"
  - option "7.0" [selected]
  - option "7.5"
