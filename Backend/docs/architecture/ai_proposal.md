...
Before writing AI code, list every AI capability EduConsultant will eventually provide.
...
This feature-driven approach minimizes premature abstraction, keeps the architecture maintainable, and reduces the likelihood of expensive refactoring as EduConsultant evolves.
