...
def get_student_service(
    ...
    return StudentService(repository=repository, transaction_manager=transaction_manager)
...
def get_scholarship_service(
    ...
    return ScholarshipService(repository=repository, transaction_manager=transaction_manager)
