...
def upgrade() -> None:
    ...
    sa.Column('degree_level', sa.Enum('HIGH_SCHOOL', 'BACHELOR', 'MASTER', 'PHD', 'POSTDOC', 'OTHER', name='degreelevel'), nullable=False),
    sa.Column('funding_type', sa.Enum('FULLY_FUNDED', 'PARTIAL', 'TUITION_FEE_ONLY', 'SELF_FUNDED', name='fundingtype'), nullable=False),
    ...
    sa.Column('role', sa.Enum('STUDENT', 'AGENCY', 'ADMIN', name='userrole'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('verification_status', sa.Enum('PENDING', 'VERIFIED', 'REJECTED', name='agencyverificationstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_agencies_verification_status'), 'agencies', ['verification_status'], unique=False)
    ...
    sa.Column('preferred_degree', sa.Enum('HIGH_SCHOOL', 'BACHELOR', 'MASTER', 'PHD', 'POSTDOC', 'OTHER', name='degreelevel'), nullable=True),
    ...
    sa.Column('status', sa.Enum('NEW', 'CONTACTED', 'IN_PROGRESS', 'WON', 'LOST', name='leadstatus'), nullable=False),
